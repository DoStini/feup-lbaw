...
function handleSearchProducts() {
    ...
    $("#results-text").text(response.docCount ? `${response.docCount} Results` : "No results");

    response.query.forEach((target) => 
        container.append(createProduct(target)));
}
