<head>
    ...
    <script src={{ asset('js/lib/uniqueCheckbox.js') }} defer></script>
    <script src={{ asset('js/lib/select.js') }} defer></script>
    ...
    <script src={{ asset('js/numberSelector.js') }} defer></script>
