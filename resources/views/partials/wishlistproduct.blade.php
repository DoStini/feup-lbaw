  ...
  <div class="row g-6">
    <div class="col-md-3 col-12">
      <a class="icon-click" href={{route('getProduct', ['id' => $wishlistItem->id])}}>
        <img src="{{asset($wishlistItem->photos[0]->url)}}" class="img-fluid rounded-start w-100 h-100 cart-product-image">
      </a>
    </div>
      ...
      <div class="card-body container-fluid h-100">
        <div class="row h-100">
          ...
          <div class="col-4 d-flex justify-content-center">  
            <a class="icon-click bi bi-x-circle col-2 pe-2 text-end text-danger" id="remove-in-wishlist-{{$wishlistItem->id}}"
                    style="font-size:2em" 
                >
            </a>
          </div>
