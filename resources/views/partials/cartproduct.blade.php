    ...
    <div class="row g-6">
      <div class="col-md-2 col-12">
        <a class="icon-click" href={{route('getProduct', ['id' => $cart_item->id])}} >
          <img src="{{asset($cart_item->photos[0]->url)}}" class="img-fluid rounded-start w-100 h-100 cart-product-image">
        </a>
      </div>
      <div class="col-md-10">
        <div class="card-body container-fluid w-100">
          <div class="row h-100">
            ...
            <div class="col-md-3 col-4 p-md-0">
              ...
              <p class="text-center">{{$cart_item->details->amount}}</p>
            ...
            <div class="col-md-3 col-4 p-md-0">
              ...
              <p class="text-center"> {{$cart_item->price}} €</p>
            </div>
