...
<section class="page page-403 vw-100 vh-100">
    <div class="information-text information-text-403">
        ...
        <h2 class="text-center message-title">400 - Bad Request</h2>
        <p class="text-center message-error">Your browser sent a request that this server could not understand.</p>
    </div>
</section>
@endsection