...
<section class="page page-403 vw-100 vh-100">
    <div class="information-text information-text-403">
        ...
        <h2 class="text-center message-title">503 - Service Unavailable</h2>
        <p class="text-center message-error">The server is not currently available to handle your request.</p>
    </div>
</section>
@endsection